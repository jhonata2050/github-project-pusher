...
async function fixCaddyPublishDir() {
  ...
  console.log('Configurando publish_directory: /usr/share/caddy...');
  await coolifyFetch(`/applications/${coolifyAppUuid}`, {
    method: 'PATCH',
    body: JSON.stringify({
