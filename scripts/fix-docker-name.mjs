...
async function fixCustomDockerRunOptions() {
  ...
  console.log('Removendo --name myapp de custom_docker_run_options...');
  const patchRes = await fetch(`${baseUrl}/applications/${coolifyAppUuid}`, {
    method: 'PATCH',
    headers: {
