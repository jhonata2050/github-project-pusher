...
async function inspectCoolifyOptions() {
  ...
  console.log('Build packs permitidos:', ['nixpacks', 'dockerfile', 'dockercompose', 'static']);
  console.log('Docker Compose Location:', app.data?.docker_compose_location);
  console.log('Dockerfile Location:', app.data?.dockerfile_location);
}

inspectCoolifyOptions();
