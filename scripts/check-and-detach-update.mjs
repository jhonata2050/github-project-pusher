...
async function checkAndDetachUpdate() {
  ...
  const svcs = ["app_1faab31027e9_app", "app_1faab31027e9_dashboard", "app_9d845a79e685_dashboard"];
  for (const s of svcs) {
    console.log(`\n--- TAREFAS DE ${s} ---`);
