          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger id="identificationType" className="h-12 rounded-xl border-input bg-background shadow-sm">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="leadSource" className="h-12 rounded-xl border-input bg-background shadow-sm">
