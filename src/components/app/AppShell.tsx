...
export function AppShell({
  ...
  return (
    ...
    <div className={cn("min-h-screen bg-background flex flex-col", isCheckout && "h-screen overflow-hidden", isAdminArea && "lg:h-screen lg:overflow-hidden")}>
      ...
      {/* Mobile Header */}
      <header className="sticky top-0 z-[100] flex h-16 w-full shrink-0 items-center justify-between border-b border-border bg-card px-4 lg:hidden pointer-events-auto">
